...
Juliano\footnote{Carta a Francisco Vettori, 10 de dezembro de 1513.
  \emph{In}: \versal{MAQUIAVEL}, N. \emph{O Príncipe} {[}\ldots{}{]}. Trad. Lívio
...
lhe haviam concedido. (\emph{Príncipe,} cap. \versal{VII}, linha 7)\emph{.}
\end{quote}
...
e extrema malignidade da fortuna.\emph{'' (Príncipe, cap. \versal{VII}, linha 8 e
9).}
\end{quote}
...
menos se apoiou na fortuna, manteve-se mais.\emph{'' (Príncipe, cap. \versal{VI},
5)}
\end{quote}
...
cidadãos, torna-se príncipe da sua pátria.'' (Príncipe, \versal{VIII}, linha 1 e
2)}
\end{quote}
...
grandes}.\emph{'' (Príncipe, \versal{IX}, 1)}
\end{quote}
...
enobrecida\emph{. (Príncipe, cap. \versal{XXVI}, linhas 7 e 29)}
\end{quote}
...
entre os excelentíssimos homens.\emph{''} (Príncipe, cap. \versal{VIII}, 10-11).
\end{quote}
...
fortes, seguros, honrados e felizes. (Príncipe, cap. \versal{VI}, 20-25)
\end{quote}
